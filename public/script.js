...
function createCalendar(date, side) {
   ...
   var monthName = currentDate.toLocaleString("zh-TW", {
      month: "long"
   });
   var yearNum = currentDate.toLocaleString("zh-TW", {
      year: "numeric"
   });
...
todayDayName.innerHTML = "Today is " + currentDate.toLocaleString("zh-TW", {
   weekday: "long",
   day: "numeric",
   month: "short"
});
